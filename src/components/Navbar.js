...
export default function Navbar(fixed){
  ...
  return (
    ...
    <div className="max-w-7xl mx-2 px-f4 sm:px-6">
      <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        ...
        <nav className="hidden md:flex space-x-10">
          <div className="relative">
            ...
            <button type="button" className="group bg-white rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" onClick={() => setListOpen1(!listOpen1)}>
              <span>Solutions</span>
              {/*
      ...
      */}
            <div className={"absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"+ (listOpen1 ? "": " hidden")}>
          ...
          <a href="/goood"   className="text-base font-medium text-gray-500 hover:text-gray-900">
            Pricing
          </a>
          <a href="/goood"   className="text-base font-medium text-gray-500 hover:text-gray-900">
            Docs
      ...
      */}
        ...
        <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
          <a href="/goood"   className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
            Sign in
          </a>
