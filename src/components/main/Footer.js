    ...
    render() {
        return (
         ...
         <div className="colorviolet">
          <div className="container px-5 pt-6 mx-auto flex items-center sm:flex-row flex-col">
            <a href="/" className="flex title-font font-bold items-center md:justify-start justify-center text-white">
              <span className="text-2xl font-bold text-pink-600 ml-2">.edusolve</span>
            </a>
        ...
        <div className="container px-5 py-8 mx-auto">
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-bold text-white tracking-widest text-sm mb-3">CATEGORIES</h2>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-bold text-white tracking-widest text-sm mb-3">SUBSCRIBE</h2>
