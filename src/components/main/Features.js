...
<div className="mx-auto container px-4 lg:px-0 text-yellow-300">
                            ...
                            <div className="lg:w-2/3 w-full xl:pr-20">
                                <div className="py-2 text-color">
                                    ...
                                    <div className="flex items-center cursor-pointer">
                                        <h3 className="f-f-r text-2xl font-semibold underline text-indigo-700 ">Lets Get Started</h3>
                                        <div className="pl-2">
                ...
                <div className="pb-32 pt-16">
                    <div className="mx-auto">
                        <div className="flex flex-wrap flex-row-reverse items-center">
                            <div className="lg:w-2/3 w-full lg:pl-20">
                                <div className="py-2 text-color">
                            ...
                            <div className="lg:w-1/3 w-full relative h-96 flex items-end justify-center ">
                                ...
                                <div className="relative z-10 p-4 bg-white shadow rounded mx-auto w-9/12 -mb-20">
                                    ...
                                    <button className="relative focus:outline-none mt-4 py-2 pr-10 bg-indigo-700 text-white tracking-normal text-xs pl-3 cursor-pointer">
                                        View Invoice
...
<div className="container mx-auto pt-16">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div className="flex justify-center">
              <button className="inline-flex text-white bg-indigo-500 border-0 py-3 px-8 focus:outline-none hover:bg-indigo-600 rounded-full text-lg">Academy</button>
            </div>
          </div>
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">Copper mug try-hard pitchfork pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic tumeric truffaut hexagon try-hard chambray.</p>
            <div className="flex justify-center">
              <button className="inline-flex text-white bg-indigo-500 border-0 py-3 px-8 focus:outline-none hover:bg-indigo-600 rounded-full text-lg">Button</button>
            </div>
          </div>
        </div>
            </div>
