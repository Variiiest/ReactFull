        ...
        <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
          ...
          <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
              ...
              <li><a href="/" className="inline-block py-2 px-3 text-gray-300  font-medium hover:text-white no-underline">Features</a></li>
              <li><a href="/" className="inline-block py-2 px-3 text-gray-300  font-medium hover:text-white no-underline">Integrations</a></li>
              <li><a href="/" className="inline-block py-2 px-3 text-gray-300  font-medium hover:text-white no-underline">Pricing</a></li>
              <li><a href="/" className="inline-block py-2 px-3 text-gray-300  font-medium hover:text-white no-underline">FAQ</a></li>
            </ul>
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
              <li className="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Company</li>
              <li><a href="/" className="inline-block py-2 px-3 text-gray-300  font-medium hover:text-white no-underline">Privacy</a>
              </li>
              <li><a href="/" className="inline-block py-2 px-3 text-gray-300  font-medium hover:text-white no-underline">Terms of Service</a></li>
            </ul>
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
              <li className="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Developers</li>
              <li><a href="/" className="inline-block py-2 px-3 text-gray-300  font-medium hover:text-white no-underline">Developer API</a></li>
              <li><a href="/" className="inline-block py-2 px-3 text-gray-300  font-medium hover:text-white no-underline">Documentation</a></li>
              <li><a href="/" className="inline-block py-2 px-3 text-gray-300  font-medium hover:text-white no-underline">Guides</a></li>
            </ul>
