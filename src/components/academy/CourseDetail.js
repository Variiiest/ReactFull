...
<div className="bg-gray-900 text-white text-gray-600 h-screen flex overflow-hidden text-sm">
        <div className="bg-white bg-gray-900 border-gray-800 w-20 flex-shrink-0 border-r border-gray-200 flex-col hidden sm:flex">
          ...
          <div className="flex mx-auto flex-grow mt-4 flex-col text-gray-400 space-y-4">
            ...
            <button className="h-10 w-12 bg-gray-700 text-white rounded-md flex items-center justify-center bg-blue-100 text-blue-500">
              <svg viewBox="0 0 24 24" className="h-5" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex-grow overflow-hidden h-full flex flex-col">
          <div className="h-16 lg:flex w-full border-b border-gray-200 border-gray-800 hidden px-10">
            <div className="flex h-full text-gray-600 text-gray-400">
              <a href="#" className="cursor-pointer h-full border-b-2 border-transparent inline-flex items-center mr-8">Company</a>
              <a href="#" className="cursor-pointer h-full border-b-2 border-blue-500 text-blue-500 text-white border-white inline-flex mr-8 items-center">Users</a>
            ...
            <div className="ml-auto flex items-center space-x-7">
              ...
              <button className="flex items-center">
                <span className="relative flex-shrink-0">
                  ...
                  <span className="absolute right-0 -mb-0.5 bottom-0 w-2 h-2 rounded-full bg-green-500 border border-white border-gray-900" />
                </span>
          ...
          <div className="flex-grow flex overflow-x-hidden scroll-hid">
            <div className="xl:w-72 w-48 flex-shrink-0 border-r border-gray-200 border-gray-800 h-full overflow-y-auto lg:block hidden p-5">
              <div className="text-xs text-gray-400 tracking-wider">USERS</div>
              <div className="relative mt-2">
                <input type="text" className="pl-8 h-9 bg-transparent border border-gray-300 border-gray-700 text-white w-full rounded-md text-sm" placeholder="Search" />
              ...
              <div className="space-y-4 mt-3">
                <button className="bg-white p-3 w-full flex flex-col rounded-md bg-gray-800 shadow">
                  <div className="flex xl:flex-row flex-col items-center font-medium text-gray-900 text-white pb-2 mb-2 xl:border-b border-gray-200 border-opacity-75 border-gray-700 w-full">
                  ...
                  <div className="flex items-center w-full">
                    <div className="text-xs py-1 px-2 leading-none bg-gray-900 bg-blue-100 text-blue-500 rounded-md">Design</div>
                    <div className="ml-auto text-xs text-gray-500">$1,902.00</div>
                  </div>
                </button>
                <button className="bg-white p-3 w-full flex flex-col rounded-md bg-gray-800 shadow-lg relative ring-2 ring-blue-500 focus:outline-none">
                  <div className="flex xl:flex-row flex-col items-center font-medium text-gray-900 text-white pb-2 mb-2 xl:border-b border-gray-200 border-opacity-75 border-gray-700 w-full">
                  ...
                  <div className="flex items-center w-full">
                    <div className="text-xs py-1 px-2 leading-none bg-gray-900 bg-green-100 text-green-600 rounded-md">Sales</div>
                ...
                <button className="bg-white p-3 w-full flex flex-col rounded-md bg-gray-800 shadow">
                  ...
                  <div className="flex items-center w-full">
                    <div className="text-xs py-1 px-2 leading-none bg-gray-900 bg-yellow-100 text-yellow-600 rounded-md">Marketing</div>
            ...
            <div className="flex-grow bg-white bg-gray-900 overflow-y-auto">
              <div className="sm:px-7 sm:pt-7 px-4 pt-4 flex flex-col w-full border-b border-gray-200 bg-white bg-gray-900 text-white border-gray-800 sticky top-0">
                <div className="flex w-full items-center">
                  <div className="flex items-center text-3xl text-gray-900 text-white">
                  ...
                  <div className="ml-auto sm:flex hidden items-center justify-end">
                    <div className="text-right">
                      <div className="text-xs text-gray-400 text-gray-400">Account balance:</div>
                      <div className="text-gray-900 text-lg text-white">$2,794.00</div>
                    </div>
                    <button className="w-8 h-8 ml-4 text-gray-400 shadow text-gray-400 rounded-full flex items-center justify-center border border-gray-200 border-gray-700">
                ...
                <div className="flex items-center space-x-3 sm:mt-7 mt-4">
                  <a href="#" className="px-3 border-b-2 border-blue-500 text-blue-500 text-white border-white pb-1.5">Activities</a>
                  <a href="#" className="px-3 border-b-2 border-transparent text-gray-600 text-gray-400 pb-1.5">Transfer</a>
                  <a href="#" className="px-3 border-b-2 border-transparent text-gray-600 text-gray-400 pb-1.5 sm:block hidden">Budgets</a>
                  <a href="#" className="px-3 border-b-2 border-transparent text-gray-600 text-gray-400 pb-1.5 sm:block hidden">Notifications</a>
                  <a href="#" className="px-3 border-b-2 border-transparent text-gray-600 text-gray-400 pb-1.5 sm:block hidden">Cards</a>
                </div>
              </div>
              <div className="sm:p-7 p-4">
                <div className="flex w-full items-center mb-7">
                  <button className="inline-flex mr-3 items-center h-8 pl-2.5 pr-2 rounded-md shadow text-gray-700 text-gray-400 border-gray-800 border border-gray-200 leading-none py-0">
                    <svg viewBox="0 0 24 24" className="w-4 mr-2 text-gray-400 text-gray-600" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    Last 30 days
                    <svg viewBox="0 0 24 24" className="w-4 ml-1.5 text-gray-400 text-gray-600" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="6 9 12 15 18 9" />
                    </svg>
                  </button>
                  <button className="inline-flex items-center h-8 pl-2.5 pr-2 rounded-md shadow text-gray-700 text-gray-400 border-gray-800 border border-gray-200 leading-none py-0">
                    Filter by
                    <svg viewBox="0 0 24 24" className="w-4 ml-1.5 text-gray-400 text-gray-600" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="6 9 12 15 18 9" />
                    </svg>
                  ...
                  <div className="ml-auto text-gray-500 text-xs sm:inline-flex hidden items-center">
                    ...
                    <button className="inline-flex mr-2 items-center h-8 w-8 justify-center text-gray-400 rounded-md shadow border border-gray-200 border-gray-800 leading-none py-0">
                    ...
                    <button className="inline-flex items-center h-8 w-8 justify-center text-gray-400 rounded-md shadow border border-gray-200 border-gray-800 leading-none py-0">
                      <svg className="w-4" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                <table className="w-full text-left">
                  <thead>
                    <tr className="text-gray-400">
                      <th className="font-normal px-3 pt-0 pb-3 border-b border-gray-200 border-gray-800">Type</th>
                      <th className="font-normal px-3 pt-0 pb-3 border-b border-gray-200 border-gray-800">Where</th>
                      <th className="font-normal px-3 pt-0 pb-3 border-b border-gray-200 border-gray-800 hidden md:table-cell">Description</th>
                      <th className="font-normal px-3 pt-0 pb-3 border-b border-gray-200 border-gray-800">Amount</th>
                      <th className="font-normal px-3 pt-0 pb-3 border-b border-gray-200 border-gray-800 sm:text-gray-400 text-white">Date</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-600 text-gray-100">
                    <tr>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.001 512.001" className="w-7 h-7 p-1.5 mr-2.5 rounded-lg border border-gray-200 border-gray-800">
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 md:table-cell hidden">Subscription renewal</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 text-red-500">- $120.00</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                    ...
                    <tr>
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-7 h-7 p-1.5 mr-2.5 rounded-lg border border-gray-200 border-gray-800">
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 md:table-cell hidden">Subscription renewal</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 text-red-500">- $9.99</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <div className="sm:flex hidden flex-col">
                            24.12.2020
                    ...
                    <tr>
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.005 512.005" className="w-7 h-7 p-1.5 mr-2.5 rounded-lg border border-gray-200 border-gray-800">
                            <g fill="#37474f">
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 md:table-cell hidden">Macbook Pro 13"</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 text-red-500">- $1.499.99</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <div className="sm:flex hidden flex-col">
                            24.12.2020
                    ...
                    <tr>
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <img className="w-7 h-7 mr-2.5 border border-gray-200 border-gray-800 rounded-full" src="https://images.unsplash.com/photo-1521587765099-8835e7201186?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&ixid=eyJhcHBfaWQiOjE3Nzg0fQ" alt="profile" />
                          James Smith
                        </div>
                      </td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 md:table-cell hidden">Invoice No: 37401</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 text-green-500">+ $60.00</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <div className="sm:flex hidden flex-col">
                            13.11.2020
                    ...
                    <tr>
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 md:table-cell hidden">Product purchased</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 text-red-500">- $49.99</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <div className="sm:flex hidden flex-col">
                            10.03.2020
                    ...
                    <tr>
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 427.652 427.652" className="w-7 h-7 p-1.5 mr-2.5 rounded-lg border border-gray-200 border-gray-800">
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 md:table-cell hidden">Subscription renewal</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 text-red-500">- $5.99</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <div className="sm:flex hidden flex-col">
                            02.04.2020
                    ...
                    <tr>
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="2.17 0.44 251.04 259.97" className="w-7 h-7 p-1.5 mr-2.5 rounded-lg border border-gray-200 border-gray-800">
                            <g fill="none" fillRule="evenodd">
                              <path fill="#f90" fillRule="nonzero" d="M221.5 210.32C116.27 260.41 50.96 218.5 9.15 193.05c-2.59-1.6-6.98.38-3.17 4.76 13.93 16.89 59.57 57.6 119.15 57.6 59.63 0 95.1-32.54 99.53-38.21 4.4-5.63 1.3-8.73-3.16-6.88zM251.06 194c-2.83-3.68-17.19-4.36-26.22-3.25-9.05 1.07-22.64 6.6-21.46 9.93.61 1.24 1.85.68 8.06.12 6.24-.62 23.7-2.82 27.34 1.93 3.66 4.8-5.57 27.61-7.25 31.3-1.63 3.67.62 4.62 3.68 2.17 3.01-2.45 8.47-8.8 12.14-17.77 3.64-9.03 5.85-21.63 3.7-24.43z" />
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 md:table-cell hidden">PlayStation 5</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 text-red-500">- $399.99</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <div className="sm:flex hidden flex-col">
                            08.09.2020
                    ...
                    <tr>
                      ...
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <img className="w-7 h-7 mr-2.5 border border-gray-200 border-gray-800 rounded-full" src="https://images.unsplash.com/photo-1519699047748-de8e457a634e?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&ixid=eyJhcHBfaWQiOjE3Nzg0fQ" alt="profile" />
                          Jane Cooper
                        </div>
                      </td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 md:table-cell hidden">Invoice No: 12993</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800 text-green-500">+ $24.00</td>
                      <td className="sm:p-3 py-2 px-1 border-b border-gray-200 border-gray-800">
                        <div className="flex items-center">
                          <div className="sm:flex hidden flex-col">
                            01.04.2020
                ...
                <div className="flex w-full mt-5 space-x-2 justify-end">
                  <button className="inline-flex items-center h-8 w-8 justify-center text-gray-400 rounded-md shadow border border-gray-200 border-gray-800 leading-none">
                    <svg className="w-4" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="15 18 9 12 15 6" />
                    </svg>
                  </button>
                  <button className="inline-flex items-center h-8 w-8 justify-center text-gray-500 rounded-md shadow border border-gray-200 border-gray-800 leading-none">1</button>
                  <button className="inline-flex items-center h-8 w-8 justify-center text-gray-500 rounded-md shadow border border-gray-200 border-gray-800 bg-gray-800 text-white leading-none">2</button>
                  <button className="inline-flex items-center h-8 w-8 justify-center text-gray-500 rounded-md shadow border border-gray-200 border-gray-800 leading-none">3</button>
                  <button className="inline-flex items-center h-8 w-8 justify-center text-gray-500 rounded-md shadow border border-gray-200 border-gray-800 leading-none">4</button>
                  <button className="inline-flex items-center h-8 w-8 justify-center text-gray-400 rounded-md shadow border border-gray-200 border-gray-800 leading-none">
                    <svg className="w-4" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="9 18 15 12 9 6" />
                    </svg>
