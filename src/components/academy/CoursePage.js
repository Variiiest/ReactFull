...
<div>
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          ...
          <div className="md:w-3/5 md:pl-6">
            ...
            <div className="flex md:mt-4 mt-6">
              ...
              <Link to="/hu101" className="text-indigo-500 inline-flex items-center ml-4">Learn More
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          <div className="flex flex-wrap w-full">
            ...
            <div className="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12" src="https://dummyimage.com/1200x500" alt="step">
