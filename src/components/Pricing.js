...
class Pricing extends Component {
    render() {
        return (
            <div>
                 <section className="text-gray-100 body-font overflow-hidden bg-gray-900">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-xl text-lg font-bold  mb-2 text-gray-100 uppercase">Pricing</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-5xl text-white">Whatever cardigan tote bag tumblr</p>
            <p className="lg:w-full mx-auto leading-relaxed text-2xl text-gray-500">Lorem kljfs dgdlifg dfgdflkjdg d,fkgjdf gdfgkjdfg d fkgjdflg dfgkjdflg
            </p>
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                ...
                <h1 className="text-5xl text-gray-200 pb-4 mb-4 border-b border-gray-200 leading-none">Free</h1>
